...
class FoodsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'delivery_cost' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'food_image' => ['type' => 'string', 'length' => 200, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'price' => 1,
                'delivery_cost' => 1,
                'food_image' => 'Lorem ipsum dolor sit amet',
                'created_at' => 1606966534,
            ],
        ];
        parent::init();
    }
